...
import { Button, Card, Col, DatePicker, Drawer, Dropdown, Empty, Flex, Input, Segmented, Space, Typography } from "antd";
                                ...
                                <Flex gap={16} style={{ marginTop: '15px' }}>
                                    <Flex vertical gap={3}>
                                        <Dropdown
                                            ...
                                            menu={{
                                                items: [
                                                    { key: 1, label: (<Typography>JardiReport</Typography>) },
                                                    { key: 2, label: (<Typography>Revly</Typography>) },
                                                    { key: 3, label: (<Typography>Expo</Typography>) },
                                                ]
                                            }}
                                        >
                                            <Button style={{ width: 336, justifyContent: "space-between" }}>
